...
RUN apt-get -qqy install php-pear php mcrypt  php-dev php-cli php-sqlite3 php-mysql php-interbase php-pgsql php-curl php-mbstring php-gd php-xml php-bcmath php-zip libapache2-mod-php7.4
